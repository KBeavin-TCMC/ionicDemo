  ...
  return (
    <IonMenu contentId="main" type="overlay">
      <IonContent color="primary">
        <IonList style= {{ background : '#3880ff'}} color="primary" id="inbox-list">
        ...
        <IonList style= {{ background : '#3880ff'}} color="primary" id="labels-list">
          <IonListHeader>Labels</IonListHeader>
          {labels.map((label, index) => (
            <IonItem color="primary" lines="none" key={index}>
